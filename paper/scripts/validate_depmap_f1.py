...
DATA = os.path.join(os.environ.get('TCGA_DATA_DIR', os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'data')), 'depmap')
...
# STRING PPI
STRING_PATH = os.path.join(os.environ.get('TCGA_DATA_DIR', os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'data')), 'validation', 'string_ppi_full.txt.gz')
string_pairs = set()
try:
...
# TRRUST
TRRUST_PATH = os.path.join(os.environ.get('TCGA_DATA_DIR', os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'data')), 'validation', 'trrust_human.tsv')
trrust_pairs = set()
try:
...
# ───────────────────────────────────────────────────────────────────
result_json = {
    "engine": "causalscale v3.3.0 LowRankGNN",
